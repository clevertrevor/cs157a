...
CREATE TABLE Manager(id SERIAL PRIMARY KEY, manager_name VARCHAR(256), username VARCHAR(256), login_password VARCHAR(256), restaurant_id INTEGER);
...
CREATE TABLE Customer(id SERIAL PRIMARY KEY, username VARCHAR(256),login_password VARCHAR(256), reservation_id INTEGER, customer_name VARCHAR(256), phone_number VARCHAR(10), birthdate DATE);
