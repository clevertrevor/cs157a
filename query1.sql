...
CREATE TABLE Manager(id SERIAL PRIMARY KEY, manager_name VARCHAR(256), restaurant_id INTEGER);
...
CREATE TABLE Customer(id SERIAL PRIMARY KEY, reservation_id INTEGER, customer_name VARCHAR(256), phone_number VARCHAR(10), birthdate DATE);
